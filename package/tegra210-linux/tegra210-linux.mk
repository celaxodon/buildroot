...
TEGRA210_LINUX_VERSION = 32.5.0
TEGRA210_LINUX_SITE = https://developer.nvidia.com/embedded/L4T/r32_Release_v5.0/t210ref_release_aarch64
...
define TEGRA210_LINUX_CONFIGURE_CMDS
	...
	cp $(@D)/bootloader/t210ref/BCT/P3448_A00_lpddr4_204Mhz_P987.cfg $(@D)/bootloader/P3448_A00_lpddr4_204Mhz_P987.cfg
